...
renderHeader params =
    Html.div [ class "header_container" ]
...
renderAboutLink =
    ...
    in
        Html.div [ class "about_container" ]
            [ Html.a [ href aboutLink ]
                [ Html.text aboutLink ]
            ]
...
renderStationView params station =
    let
        ...
        mapDest =
            locationToString station.location
        ...
        backButton =
            Html.div [ class "back_button_container" ]
                [ Html.button
                    [ class "back_button"
                    , onClick ViewList
                    ]
...
render params =
    if List.isEmpty params.stations then
        renderSpinner
    else
        renderHtml params
